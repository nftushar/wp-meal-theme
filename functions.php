...
function meal_assets() {
	...
	wp_enqueue_style( 'portfolio-css', get_template_directory_uri() . '/assets/css/portfolio.css', null, VERSION );
	...
	wp_enqueue_script( 'popper-js', get_template_directory_uri() . '/assets/js/jquery-migrate-3.0.1.min.js', array( 'jquery' ), VERSION, true );
	...
	wp_enqueue_script( 'isotope-pkgd', get_template_directory_uri() . '/assets/js/isotope.pkgd.min.js', array( 'jquery' ), VERSION, true );
