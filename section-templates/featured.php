        ...
        <div class="row section-heading justify-content-center mb-5">
            <div class="col-md-8 text-center">
                ...
                <p class="sub-heading mb-5">
                    <?php print_r(wp_kses_post($meal_section_description), ); ?>
                </p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="ftco-46">
                <div class="ftco-46-row d-flex flex-column flex-lg-row">
                    <div class="ftco-46-image"
                        style="background-image: url(<?php echo esc_url(get_the_post_thumbnail_url($meal_recipe_one,"large"));?>);">
                    </div>
                    ...
                    <div class="ftco-46-image"
                        style="background-image: url(<?php echo esc_url( get_the_post_thumbnail_url($meal_recipe_three,"large"));?>);">
                ...
                <div class="ftco-46-row d-flex flex-column flex-lg-row">
                    ...
                    <div class="ftco-46-image"
                        style="background-image: url(<?php echo esc_url( get_the_post_thumbnail_url($meal_recipe_two,"large"));?>);">
                    </div>
